...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b-gray-400 shadow-md backdrop-blur-xl '>
      <img onClick={() => navigate('/')} className='w-44 cursor-pointer pl-5' src={assets.logo} alt="" />
