...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 shadow-xl rounded-sm pb-8'>
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='flex flex-row bg-orange-500 text-white px-12 py-2 rounded-full mt-9 hover:bg-white hover:text-orange-500 gap-3 hover:shadow-lg transition ease-in-out duration-100 hover:delay-150 hover:shadow-orange-200'>More</button>
    </div>
  );
};
