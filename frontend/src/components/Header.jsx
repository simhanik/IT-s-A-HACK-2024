    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-gradient-to-tr from-[#EE9AE5] to-[#5961F9] rounded-lg px-6 md:px-10 lg:px-20'>
       ...
       <div className='ed:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
         ...
         <div className='flex flex-col md:flex-row items-center gap-5 text-white text-[13px] font-light '>
            ...
            <p className=' text-sm'> HealthConnect is a comprehensive health appointment <br />
         ...
         <a href="#speciality" className='flex items-center gap-2 px-8 py-3 rounded-full text-white text-sm m-auto md:m-0 hover:scale-105 transition-all ease-in-out duration-100 hover:delay-150 bg-orange-500 hover:bg-white hover:text-orange-500 hover:shadow-xl hover:shadow-orange-200' >
       ...
       {/* { ------Right Side----- } */}
         <div className='md:w-1/2 relative'>
           <img className='w-full md:absolute bottom-24 h-auto rounded-lg' src={assets.pngegg} alt="" />
        </div>
    </div>
  )
}
